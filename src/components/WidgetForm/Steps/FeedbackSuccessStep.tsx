    ...
    <>
      ...
      <div className='flex flex-col items-center py-10 w-[304px]'>
        ...
        <button
          ...
          className='py-2 px-6 mt-6 bg-surface-secondary rounded-md border-transparent text-sm leading-6 hover:bg-secondary-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-surface-primary focus:ring-brand-500 transition-colors'>
          Quero enviar outro
        </button>
      </div>
    </>
